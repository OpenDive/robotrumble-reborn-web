import type { ZkLoginInitResponse, ZkLoginCompleteResponse, ZkLoginState } from '@/app/api/zk-login/types';
...
export async function completeZkLogin(jwt: string, zkLoginState: ZkLoginState): Promise<string> {
  try {
    console.log('Completing ZK Login with:', {
      // TODO: Why are we doing this? This probably messes up the proof call.
